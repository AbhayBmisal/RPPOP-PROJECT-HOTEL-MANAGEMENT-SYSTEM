...
#cur.execute("insert into paymentsf values(1,'Abhay','Misal','9589861196','hi.abhaymisal@gmail.com',2,'1','11','2023','11:20:27 PM','Cash','3500')")
...
Label(sroot,text="Abhay Misal",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="hi.abhaymisal@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
#Label(sroot,text="9589861196",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=450)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	root.geometry('1080x530')
	root.minsize(width=1080,height=550)
	root.maxsize(width=1080,height=550)
	root.configure(bg='white')
	root.title(" अतिथि देवो भव:। ")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#def connectprinter():
		#os.startfile("C:/Users/TestFile.txt", "print")     ----commented by me
	#---------------top frame------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Abhay',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Abhay B. Misal",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Aparna Chothe",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. Rishi Patil(Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. Nanda (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
